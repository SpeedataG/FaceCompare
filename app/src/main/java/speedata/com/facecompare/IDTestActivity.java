package speedata.com.facecompare;
...
import com.speedata.identitycard.FaceCompare;
...
import speedata.com.facecompare.R;

import static com.speedata.identitysoftware.IdentitySoftware.COM_SPEEDATA_SOFTWARE_ID;

public class IDTestActivity extends Activity implements View.OnClickListener {
...
//        });
        ...
        btnGet.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                ...
                if (b) {
                    timer.schedule(new IDTestActivity.readIDTask(), 1000, 1000);
                } else {
                    timer.cancel();
                    timer = null;
                }
...
//                myCamera.setState(b);
    ...
    private void initID() {
        ...
        try {
            boolean result = iid2Service.initDev(IDTestActivity.this, new IDReadCallBack() {
                @Override
...
//                    , 94);
            ...
            if (!result) {
                new AlertDialog.Builder(IDTestActivity.this).setCancelable(false).setMessage("二代证模块初始化失败")
...
//        viewFinger.invalidate();
    ...
    private void showToast(String msg) {
        Toast.makeText(IDTestActivity.this, msg, Toast.LENGTH_LONG).show();
    }
    ...
    private void enableReaderMode() {
        ...
        if (nfcAdapter != null) {
            nfcAdapter.enableReaderMode(this, new IDTestActivity.MyReaderCallback(), READER_FLAGS, options);
        }
    }
